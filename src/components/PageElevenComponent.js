...
import { call11 } from '../services/DataServices.js'
...
export default function PageElevenComponent() {
    ...
    const getResult = async () => {
        const response = await call11(name);
        setResult(response)
    }
    ...
    return (
        ...
        <div className="bg-[#F1A382] py-[1px]">
            <div
                ...
                <p id="p2Text" className="lg:text-[100px] text-[20px]">{result === undefined ? hold : result}</p>
