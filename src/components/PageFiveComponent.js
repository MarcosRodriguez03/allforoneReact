...
import { call5 } from '../services/DataServices.js'
...
export default function PageFiveComponent() {
    ...
    const getResult = async () => {
        const response = await call5(numOne, numTwo);
        setResult(response)
    }
    ...
    return (
        <div class="bg-[#FAC886] py-[1px]">
            ...
            <div
                ...
                <p id="p3Text" class="lg:text-[100px] text-[20px]">{result === undefined ? "Enter Two Numbers" : result}</p>
            </div>
