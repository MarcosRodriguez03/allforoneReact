...
export default function PageSixComponent() {
    ...
    const getResult = async () => {
        ...
        if (
            ...
            setResult("Enter The Given Fields")
        } else {

            const response = await call6(numOne,
                numTwo,
                numThree,
                numFour,
                numFive,
    ...
    return (
        <div className="bg-[#DC8C83] py-[1px]">
            <div
                ...
                <p id="p6Text" className="lg:text-[100px] text-[20px] p-10">{result === "" ? "Enter The Given Fields" : result}</p>
            </div>
